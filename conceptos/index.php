...
<div class="card mb-4">
    <div class="card-header">Añadir/Editar Concepto</div>
    <div class="card-body">
        <form action="store.php" method="POST">
            <div class="row">
                <div class="col-md-3 mb-3">
                    <label for="codigo_concepto" class="form-label">Código del Concepto</label>
                    <input type="text" class="form-control" id="codigo_concepto" name="codigo_concepto" placeholder="Ej: ING-HE35" required>
                </div>
                <div class="col-md-9 mb-3">
                    <label for="descripcion_publica" class="form-label">Descripción Pública</label>
                    <input type="text" class="form-control" id="descripcion_publica" name="descripcion_publica" placeholder="Ej: Ingreso Horas Extras 35%" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 mb-3">
...
<table class="table table-sm table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo htmlspecialchars($concepto['codigo_concepto']); ?></td>
            ...
            <td><?php echo $concepto['afecta_tss'] ? 'Sí' : 'No'; ?></td>
            <td><?php echo $concepto['afecta_isr'] ? 'Sí' : 'No'; ?></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
